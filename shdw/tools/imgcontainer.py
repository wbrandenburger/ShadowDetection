...
#   import ------------------------------------------------------------------
# ---------------------------------------------------------------------------
import shdw.tools.objcontainer
...
class ImgListContainer(list):
    ...
    #   method --------------------------------------------------------------
    # -----------------------------------------------------------------------
    def __init__(self, default_spec="image", load=None, live=False, obj_flag=True, obj_copy=False):
    ...
    #   method --------------------------------------------------------------
    # -----------------------------------------------------------------------
    def append(self, img=np.ndarray(0), path=None, spec=None, live=None, obj_flag=None, obj_copy=None):
        ...
        super(ImgListContainer, self).append(
            shdw.tools.imgcontainer.ImgContainer(
                img=img,
                path=path,
                spec=spec,
                load=self._load,
...
#   class -------------------------------------------------------------------
# ---------------------------------------------------------------------------
class ImgContainer(shdw.tools.objcontainer.ObjContainer):
